...
def open_pattern6_link():
    # Dictionary updated with the pattern-6.py URLs
    links = {
        "one": "https://github.com/Kaustavoffx/CODE-Oneliner/blob/873b44d9779a2c456f9c3cc3d599da24b830ce6c/Nested%20loop/pattern-6.py",
        "code": "https://github.com/Kaustavoffx/CODE-Normal/blob/978fe4a37df2969d4f2695ab2d45f16cb8026d7a/Nested%20loop/pattern-6.py"
    }
    ...
    while True:
        ...
        if res in links:
            ...
            # Your exact pattern-6 code execution
            n = 5
            sp = round(n/2)*2
